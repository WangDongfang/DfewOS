...
void set_src_addr(s3c_pp_instance_context_t *pp_instance)
{
	...
	buf_addr.offset_y           = (pp_instance->src_full_width - pp_instance->src_width) 
					* pp_instance->in_pixel_size;
	buf_addr.start_pos_y        = (pp_instance->src_full_width * pp_instance->src_start_y 
					+ pp_instance->src_start_x) * pp_instance->in_pixel_size;
	buf_addr.end_pos_y          = pp_instance->src_width * pp_instance->src_height 
					* pp_instance->in_pixel_size 
					+ buf_addr.offset_y * (pp_instance->src_height - 1);
#if 0
...
#else
	buf_addr.src_frm_start_addr = pp_instance->src_buf_addr_phy[0];
	buf_addr.src_start_y        = pp_instance->src_buf_addr_phy[0] + buf_addr.start_pos_y;
#endif                                                                  /*  charnge by cmj              */
	buf_addr.src_end_y          = buf_addr.src_start_y + buf_addr.end_pos_y;

	if (pp_instance->src_color_space == YC420) {
		buf_addr.offset_cb    = buf_addr.offset_cr 
		                      = ((pp_instance->src_full_width - pp_instance->src_width) / 2)
		                         * pp_instance->in_pixel_size;
		buf_addr.start_pos_cb = pp_instance->src_full_width * pp_instance->src_full_height
					+ (pp_instance->src_full_width * pp_instance->src_start_y / 2 
					+ pp_instance->src_start_x) / 2;

		buf_addr.end_pos_cb   = pp_instance->src_width / 2 * pp_instance->src_height / 2 
			                  * pp_instance->in_pixel_size 
			                + (pp_instance->src_height / 2 - 1) * buf_addr.offset_cb;
		buf_addr.start_pos_cr = pp_instance->src_full_width * pp_instance->src_full_height
					+ pp_instance->src_full_width 
					  * pp_instance->src_full_height / 4
					+ (pp_instance->src_full_width 
					     * pp_instance->src_start_y / 2 
					   + pp_instance->src_start_x) / 2;
		buf_addr.end_pos_cr   = pp_instance->src_width / 2 * pp_instance->src_height / 2 
			                  * pp_instance->in_pixel_size
...
#else
		//buf_addr.src_start_cb = pp_instance->src_buf_addr_phy[0] + buf_addr.start_pos_cb;
		buf_addr.src_start_cb = pp_instance->src_buf_addr_phy[1];
#endif                                                                  /*  charnge by cmj              */
...
#else
		//buf_addr.src_start_cr = pp_instance->src_buf_addr_phy[0] + buf_addr.start_pos_cr;
		buf_addr.src_start_cr = pp_instance->src_buf_addr_phy[2];
#endif                                                                  /*  charnge by cmj              */
...
void set_dest_addr(s3c_pp_instance_context_t *pp_instance)
{
	...
	if (DMA_ONESHOT == pp_instance->out_path) {
		buf_addr.offset_rgb    = (pp_instance->dst_full_width - pp_instance->dst_width) 
			                 * pp_instance->out_pixel_size;
		buf_addr.start_pos_rgb = (pp_instance->dst_full_width * pp_instance->dst_start_y 
			                   + pp_instance->dst_start_x) 
			                 * pp_instance->out_pixel_size;
		buf_addr.end_pos_rgb   = pp_instance->dst_width * pp_instance->dst_height 
			                   * pp_instance->out_pixel_size 	\
				         + buf_addr.offset_rgb * (pp_instance->dst_height - 1);
#if 0
		buf_addr.dst_start_rgb 	= pp_instance->dst_buf_addr_phy + buf_addr.start_pos_rgb;
#else
		buf_addr.dst_start_rgb 	= pp_instance->dst_buf_addr_phy[0] + buf_addr.start_pos_rgb;
#endif                                                                  /*  charnge by cmj              */
		buf_addr.dst_end_rgb 	= buf_addr.dst_start_rgb + buf_addr.end_pos_rgb;

		if (pp_instance->dst_color_space == YC420) {
			buf_addr.out_offset_cb    = buf_addr.out_offset_cr 
				                  = ((pp_instance->dst_full_width 
				                      - pp_instance->dst_width) / 2) 
				                    * pp_instance->out_pixel_size;
			buf_addr.out_start_pos_cb = pp_instance->dst_full_width 
				                      * pp_instance->dst_full_height
						    + (pp_instance->dst_full_width 
						         * pp_instance->dst_start_y / 2 
						       + pp_instance->dst_start_x) / 2;
			buf_addr.out_end_pos_cb   = pp_instance->dst_width / 2 
			                              * pp_instance->dst_height / 2 
			                              * pp_instance->out_pixel_size
			                            + (pp_instance->dst_height / 2 - 1) 
			                              * buf_addr.out_offset_cr;

			buf_addr.out_start_pos_cr = pp_instance->dst_full_width 
				                      * pp_instance->dst_full_height
			                            + (pp_instance->dst_full_width 
			                               * pp_instance->dst_full_height / 4)
						    + (pp_instance->dst_full_width 
						         * pp_instance->dst_start_y / 2 
						       + pp_instance->dst_start_x) / 2;
			buf_addr.out_end_pos_cr   = pp_instance->dst_width / 2 
				                      * pp_instance->dst_height / 2 
				                      * pp_instance->out_pixel_size
						    + (pp_instance->dst_height / 2 - 1) 
						      * buf_addr.out_offset_cb;

#if 0
			buf_addr.out_src_start_cb = pp_instance->dst_buf_addr_phy 
				                    + buf_addr.out_start_pos_cb;
#else
			buf_addr.out_src_start_cb = pp_instance->dst_buf_addr_phy[0] 
				                    + buf_addr.out_start_pos_cb;
#endif                                                                  /*  charnge by cmj              */
			buf_addr.out_src_end_cb   = buf_addr.out_src_start_cb 
				                    + buf_addr.out_end_pos_cb;
#if 0
			buf_addr.out_src_start_cr = pp_instance->dst_buf_addr_phy 
				                    + buf_addr.out_start_pos_cr;
#else
			buf_addr.out_src_start_cr = pp_instance->dst_buf_addr_phy[0] 
				                    + buf_addr.out_start_pos_cb;
#endif                                                                  /*  charnge by cmj              */
			buf_addr.out_src_end_cr   = buf_addr.out_src_start_cr 
				                    + buf_addr.out_end_pos_cr;
		}
...
void set_scaler(s3c_pp_instance_context_t *pp_instance)
{
	...
	scaler_info.dx = (pp_instance->src_width << 8) 
				/ (pp_instance->dst_width << scaler_info.h_shift);
	...
	scaler_info.dy = (pp_instance->src_height << 8) 
				/ (pp_instance->dst_height << scaler_info.v_shift);
...
{
	return cal_data_size(pp_instance->src_color_space, 
				pp_instance->src_full_width, 
				pp_instance->src_full_height);
}

int get_dest_data_size(s3c_pp_instance_context_t *pp_instance)
{
	return cal_data_size(pp_instance->dst_color_space, 
				pp_instance->dst_full_width, 
				pp_instance->dst_full_height);
}
