...
#ifndef __ETHIF_AX88796_H__
#define __ETHIF_AX88796_H__
...
#define AX88796_BUFSIZ	    (ETHERMTU + SIZEOF_ETHERHEADER + EADDR_LEN)
...
#define AX88796B_BASE		0x18000000

#define SROM_BAND1_Tacs  (0x1)                                          /*  1 clk                       */
#define SROM_BAND1_Tcos  (0x1)                                          /*  1 clk                       */
#define SROM_BAND1_Tacc  (0x7)                                          /*  8 clk                       */
#define SROM_BAND1_Tcoh  (0x1)                                          /*  1 clk                       */
#define SROM_BAND1_Tcah  (0x1)                                          /*  1 clk                       */
#define SROM_BAND1_Tacp  (0)                                            /*  0 clk                       */
...
/*********************************************************************************************************
  驱动程序功能模块配置
*********************************************************************************************************/
//#define LWIP_LINK_STAT                                                  /* 启用netstat链路层信息记录    */
//#define LINK_SNMP_STAT                                                  /* 启用SNMP链路层信息记录       */
//#define AX_WATCHDOG_SUPPORT                                             /* 启用Watchdog功能             */
//#define AX_MII_SUPPORT                                                  /* 启用MII接口读写函数          */

/* ********************************************************************* */
/* Interface function definition */

err_t ethdev_init           (struct netif *netif);
err_t ax_set_phy_mode       (struct netif *netif, uint8 mode);
/* ********************************************************************* */

/*======================================================================
  GPIO registers
======================================================================*/
#define rGPECON         (*(volatile unsigned int *)0x7F008080)
#define rGPEDAT         (*(volatile unsigned int *)0x7F008084)
#define rGPEPUD         (*(volatile unsigned int *)0x7F008088)
#define rGPECONSLP      (*(volatile unsigned int *)0x7F00808C)
#define rGPEPUDSLP      (*(volatile unsigned int *)0x7F008090)
...
#define rSROM_BW        (*(volatile unsigned int *)0x70000000)
#define rSROM_BC1       (*(volatile unsigned int *)0x70000008)


typedef void (*EXE_FUNC_PTR) (uint32 arg1, uint32 arg2);
