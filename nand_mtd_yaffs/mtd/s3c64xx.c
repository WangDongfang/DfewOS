...
int board_nand_init(struct nand_chip *nand)
{
	...
	GPPCON_REG = (GPPCON_REG & ~(0xfff << 4)) | (0xaaa << 4);           /*  GPIO 设置                   */
...
#define NAND_TWRPH1                 2                                   /*  nWE 高电平保持时间(Min:15ns)*/
    ...
    NFCONF_REG = (NAND_TACLS << 12)                                     /*  HCLK x (TACLS)              */
            | (NAND_TWRPH0 << 8)                                        /*  HCLK x (TWRPH0 + 1)         */
            | (NAND_TWRPH1 << 4)                                        /*  HCLK x (TWRPH1 + 1)         */
            | (1 << 2);                                                 /*  Reserved. Must be written 1 */

    NFCONT_REG = (0 << 17)                                              /*  Disable lock-tight          */
            | (0 << 16)                                                 /*  Disable Soft lock           */
            | (0 << 12)                                                 /*  Disable 4/8-bit ECC intrrupt*/
            | (0 << 10)                                                 /*  Disable interrupt           */
            | (0 <<  9)                                                 /*  Disable RnB interrupt       */
            | (0 <<  8)                                                 /*  RnB Detect rising edge      */
            | (1 <<  7)                                                 /*  Lock main data area ECC     */
            | (1 <<  6)                                                 /*  Lock spare ECC              */
            | (1 <<  5)                                                 /*  Init Main ECC de/encoder    */
            | (1 <<  4)                                                 /*  Init Spare ECC de/encoder   */
            | (1 <<  2)                                                 /*  Force nFCE1 to high         */
                                                                        /*  (Disable chip select)       */
            | (1 <<  1)                                                 /*  Force nFCE0 to high         */
                                                                        /*  (Disable chip select)       */
